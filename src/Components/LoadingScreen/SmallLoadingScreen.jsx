...
import "./SmallLoadingScreen.css";  // Du kannst das CSS nach deinem Stil anpassen.
...
const SmallLoadingScreen = () => {
  ...
  useEffect(() => {
    ...
    }, 1500); // 1 Sekunde für den kurzen Ladebildschirm

    return () => clearTimeout(timer); // Aufräumen der Timer-Ressourcen
  }, []);

  return (
    <div className={`small-container z-50 ${isAnimationComplete ? "fade-out" : ""}`}>
